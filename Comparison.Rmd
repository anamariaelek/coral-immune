...
eul <- plot(
  fit_eu,
  quantities = TRUE,
  #fills = c(sps_cols[rownames(fit_eu$ellipses)]),
...
marks_cvig[, treatment := "capup_cvig"][, gene_id := NULL]

marks_fcs <- rbindlist(list(marks_spis, marks_cvig), use.names = TRUE)
marks_fcs[, minuslog10padj := -1 * log10(padj)]
marks_fcs[, sample := switch(treatment,
  cApUp = "S. pistillata cApUp",
  cGAMP = "S. pistillata cGAMP",
  capup_cvig = "C. virginica cApUp"
