...
label_genes[, pfam := str_replace_all(pfam, c(
  "IRF3/IRF4/IRF5/IRF6/IRF7/IRF8/IRF9" = "IRF3-9",
  "NFKB1/NFKB2/REL/RELA/RELB" = "NFKB1/2",
  "STAT5A/STAT5B/STAT6" = "STAT5-6"
)
)]
label_genes_v <- structure(label_genes$pfam, names = label_genes$gene)
...
gp_capup_vo <- ggplotVolcano(
  ...
  shape_column = "label", raster = FALSE,
  label_column = "label_gene", label_fc_thr = 0.5
) +
  geom_point(
